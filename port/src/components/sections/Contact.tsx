...
const SOCIALS = [
  ...
  { icon: Mail, label: "Email", href: "mailto:hello@luxe.work" },
];
          ...
          <Reveal className="lg:col-span-2">
            <div className="relative mx-auto flex max-w-sm flex-col items-center text-center">
              ...
              <div className="w-full space-y-3 text-left">
                {[
                  { icon: Mail, label: "hello@luxe.work" },
                  { icon: MapPin, label: "Berlin · Remote worldwide" },
                  ...
                  >
                    <span className="grid h-10 w-10 place-items-center rounded-xl bg-neon/[0.08] text-neon">
                      <r.icon size={17} />
                    </span>
