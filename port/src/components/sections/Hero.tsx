  ...
  return (
    ...
    >
      ...
      >
        <motion.span
          {...fadeUp(0.15)}
          className="glass mb-8 inline-flex items-center gap-2 rounded-full px-5 py-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-mist"
        >
        ...
        >
          Ariadne<span className="text-gradient-gold"> Voss</span>
        </motion.h1>
        ...
        <motion.p
          {...fadeUp(0.58)}
          className="mt-5 max-w-xl text-[15px] leading-relaxed text-mist sm:text-base"
        >
          I design and build digital products where engineering precision
          meets cinematic craft — glass, glow, motion, and code that performs.
        </motion.p>
